...
|---------|--------|---------|
| `rtcm-server` | `rtcm_server.py` | Receives RTCM GPS correction data, serves it to GPS modules |
| `teensy-bridge` | `teensy_serial_bridge.py` | Serial bridge between RPi and Teensy 4.1 (starts after rtcm-server) |
