...
`teensy_serial_bridge_{date}.py` This bridge reads serial data from the Teensy microcontroller and broadcasts key system status via UDP at 10 Hz for monitoring and control. See the Miro Board for more details.
