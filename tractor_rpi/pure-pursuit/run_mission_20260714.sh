...
#
# Usage:
#   ./run_mission_20260714.sh                        # default: RTK Fixed required
#   ./run_mission_20260714.sh --min-fix "RTK Float"  # relaxed gate for testing
#
...
#      how the run ends.
#
# Repository location: tractor_rpi/pure-pursuit/run_mission_20260714.sh
...
MISSION="mission_out_and_back_20260713.txt"
LOGGER="field_test_logger_20260710.py"
