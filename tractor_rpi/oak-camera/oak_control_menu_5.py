...
def generate_frames():
    ...
    global latest_frame, robot_status, show_crosshair, show_grid, show_telemetry
    ...
    while True:
        with frame_lock:
            if latest_frame is not None:
                ...
                # Create black frame if no camera data
        ...
        # Add telemetry overlay (using the working approach from test script)
        if show_telemetry:
            # Background box
            cv2.rectangle(frame, (10, 10), (380, 180), (0, 0, 0), -1)
            cv2.rectangle(frame, (10, 10), (380, 180), (0, 255, 0), 2)
