#!/usr/bin/env python3
"""Analyze the 2026-09-08 Ring 13 three-speed calibration field log."""
...
EXPECTED_TARGETS = {0.75: 2429, 1.00: 2288, 1.25: 2240, 1.50: 2200}
TRIM_SECONDS = 5.0
...
def main() -> None:
    ...
    json_path = args.output_dir / "ring13_three_speed_analysis_20260908.json"
    json_path.write_text(json.dumps(summaries, indent=2) + "\n", encoding="utf-8")

    csv_path = args.output_dir / "ring13_three_speed_summary_20260908.csv"
    columns = [
    ...
    timeline.set(
        title="Ring 13 three-speed calibration — 2026-09-08",
    ...
    figure.tight_layout()
    plot_path = args.output_dir / "ring13_three_speed_speed_vs_command_20260908.png"
