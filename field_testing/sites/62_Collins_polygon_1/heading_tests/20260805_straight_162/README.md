...
This is a 15.0 m straight-only diagnostic beginning near the reviewed Polygon 1
start pose and proceeding at compass heading 170 degrees.
...
centerline-to-boundary clearance is approximately 1.19 m, so this is a tightly
