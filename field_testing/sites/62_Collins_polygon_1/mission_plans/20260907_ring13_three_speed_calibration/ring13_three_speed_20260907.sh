#!/usr/bin/env bash
# Supervised, blades-off launcher for the 2026-09-07 Ring 13 speed-calibration test.

set -euo pipefail

SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
TRACTOR_REPO="${TRACTOR_REPO:-/home/al/tractor2025}"
BUILDER="${SCRIPT_DIR}/build_ring13_three_speed_mission_20260907.py"
...
expected_counts = Counter({"0.75": 66, "1.00": 146, "1.25": 147, "1.50": 147})
...
print("PASS: generated mission has 506 rows and the intended three speed laps.")
PY
...
echo "============================================================"
echo " RING 13 THREE-SPEED CALIBRATION TEST - 2026-09-07"
...
echo " Start transit      : 15.86 m at 0.75 m/s, lookahead 1.5 m"
echo " Lap 1              : 1.00 m/s command -> Teensy JRK 2288"
echo " Lap 2              : 1.25 m/s command -> Teensy JRK 2240"
echo " Lap 3              : 1.50 m/s command -> Teensy JRK 2200"
...
echo
read -r -p 'Type RUN RING13 SPEED CAL TEST BLADES OFF to start: ' confirmation
if [[ "${confirmation}" != "RUN RING13 SPEED CAL TEST BLADES OFF" ]]; then
    echo "Aborted; nothing was started."
    exit 1
fi

mkdir -p /home/al/field_logs/20260907_speed_calibration
timestamp="$(date '+%Y%m%d_%H%M%S')"
field_log="/home/al/field_logs/20260907_speed_calibration/ring13_three_speed_${timestamp}.csv"
logger_pid=""
