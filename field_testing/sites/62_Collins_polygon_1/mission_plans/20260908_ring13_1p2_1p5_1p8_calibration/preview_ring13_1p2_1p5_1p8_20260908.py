#!/usr/bin/env python3
"""Create a PNG preview of the Ring 13 1.2/1.5/1.8 m/s test."""
...
OUTPUT = SCRIPT_DIR / "ring13_1p2_1p5_1p8_preview_20260908.png"
EXPECTED_ROWS = 506
...
def main() -> None:
    if not MISSION.is_file():
        raise SystemExit(
            ...
            "Run build_ring13_1p2_1p5_1p8_mission_20260908.py first."
        )
    ...
    segments = [
        (0, 66, "Transit: 0.75 m/s -> JRK 2368", 2.2),
        (359, 506, "Lap 3: 1.80 m/s -> JRK 2135", 6.0),
        (212, 359, "Lap 2: 1.50 m/s -> JRK 2178", 4.0),
        (66, 212, "Lap 1: 1.20 m/s -> JRK 2233", 2.0),
    ]
    ...
    ax.set_title("2026-09-08 Ring 13 1.2/1.5/1.8 m/s calibration\nSame Ring 13 path repeated for three increasing speeds")
    ax.legend(loc="best")
    fig.tight_layout()
