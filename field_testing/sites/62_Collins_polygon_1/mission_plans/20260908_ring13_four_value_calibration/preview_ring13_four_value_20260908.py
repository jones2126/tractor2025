#!/usr/bin/env python3
"""Create a PNG preview of the 2026-09-08 Ring 13 four-value retest."""
...
OUTPUT = SCRIPT_DIR / "ring13_four_value_preview_20260908.png"
EXPECTED_ROWS = 506
...
def main() -> None:
    if not MISSION.is_file():
        raise SystemExit(
            ...
            "Run build_ring13_four_value_mission_20260908.py first."
        )
    ...
    segments = [
        (0, 66, "Transit: 0.75 m/s -> JRK 2350", 2.2),
        (359, 506, "Lap 3: 1.50 m/s -> JRK 2160", 6.0),
        (212, 359, "Lap 2: 1.20 m/s -> JRK 2246", 4.0),
        (66, 212, "Lap 1: 1.00 m/s -> JRK 2300", 2.0),
    ]
    ...
    ax.set_title("2026-09-08 Ring 13 four-value calibration retest\nSame Ring 13 path repeated for three lap settings")
    ax.legend(loc="best")
    fig.tight_layout()
