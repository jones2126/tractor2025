#!/usr/bin/env bash
# Supervised, blades-off launcher for the 2026-09-08 Ring 13 four-value retest.

set -euo pipefail

SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)"
TRACTOR_REPO="${TRACTOR_REPO:-/home/al/tractor2025}"
BUILDER="${SCRIPT_DIR}/build_ring13_four_value_mission_20260908.py"
MISSION="${SCRIPT_DIR}/62_Collins_ring13_four_value_settings_20260908.txt"
...
expected_counts = Counter({"0.75": 66, "1.00": 146, "1.20": 147, "1.50": 147})
...
print("PASS: generated mission has 506 rows and the approved four-value schedule.")
PY
...
echo "============================================================"
echo " RING 13 FOUR-VALUE CALIBRATION RETEST - 2026-09-08"
...
echo " Start transit      : 0.75 m/s command -> Teensy JRK 2350"
echo " Lap 1              : 1.00 m/s command -> Teensy JRK 2300"
echo " Lap 2              : 1.20 m/s command -> Teensy JRK 2246"
echo " Lap 3              : 1.50 m/s command -> Teensy JRK 2160"
...
sudo python3 "${PREFLIGHT}" --expected-firmware teensy_main_20260908
...
echo
read -r -p 'Type RUN RING13 FOUR VALUE TEST BLADES OFF to start: ' confirmation
if [[ "${confirmation}" != "RUN RING13 FOUR VALUE TEST BLADES OFF" ]]; then
    echo "Aborted; nothing was started."
    exit 1
fi

mkdir -p /home/al/field_logs/20260908_four_value_calibration
timestamp="$(date '+%Y%m%d_%H%M%S')"
field_log="/home/al/field_logs/20260908_four_value_calibration/ring13_four_value_${timestamp}.csv"
logger_pid=""
