#!/usr/bin/env python3
"""Build the 2026-09-08 four-value Ring 13 calibration mission.
...
OUTPUT = SCRIPT_DIR / "62_Collins_ring13_four_value_settings_20260908.txt"
...
def main() -> None:
    ...
    print("Speeds : transit 0.75; lap1 1.00; lap2 1.20; lap3 1.50 m/s")
