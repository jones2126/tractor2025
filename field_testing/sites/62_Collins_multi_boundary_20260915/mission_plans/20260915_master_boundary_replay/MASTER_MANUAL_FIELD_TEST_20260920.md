...
3. Open the printed dashboard URL on the phone. Voice guidance can help locate **W1**. Before launch, the launcher requires RTK Fixed, fixed-carrier heading, baseline 0.80–1.30 m, heading accuracy at most 1°, position within 1.50 m of W1, and heading within 20°. It also runs the mission preflight, including firmware identity and neutral/safe-mode checks.
