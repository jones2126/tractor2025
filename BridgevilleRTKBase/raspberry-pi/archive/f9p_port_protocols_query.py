#!/usr/bin/env python3
"""
f9p_port_protocols_query.py
===========================
Query port-level protocol capabilities and settings for the F9P.

Purpose: "What protocols can each port handle?"
"""
...
if __name__ == "__main__":
    print("F9P Port Protocols Query")
    print("What protocols can each port handle?")
    print("-" * 40)
